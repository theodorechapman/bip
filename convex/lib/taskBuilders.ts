...
export function buildXAccountBootstrapTask(input: {
  ...
  return [
    ...
    "6) When asked for email verification code, STOP and wait on the verification code input screen. Do NOT close, navigate away, or continue past this screen. The code will be entered automatically.",
