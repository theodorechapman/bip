...
type EasingMode = 'elastic' | 'normal';
...
export default function CardSwap({
  ...
  const order = useRef<Array<number>>(Array.from({ length: childArr.length }, (_, i) => i));
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as React.ReactElement<React.HTMLAttributes<HTMLDivElement>>, {
          key: i,
          ref: refs[i],
